...
void testPynodeInputOutputAccess(Region_Ptr_t level2)
{
...
void testPynodeArrayParameters(Region_Ptr_t level2)
{
...
void testPynodeLinking()
{
  ...
  auto region2 = net.addRegion("region2", "py.TestNode", "");
...
void testCreationParamTypes()
{
  ...
  Network n;
  auto region = n.addRegion("test", "py.TestNode",
                               "{"
